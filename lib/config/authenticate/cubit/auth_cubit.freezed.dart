...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, isLoggedIn: $isLoggedIn, error: $error, message: $message, errorEmail: $errorEmail)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, isLoading, isLoggedIn, error, message, errorEmail);
...
abstract class _Initial implements AuthState {
  const factory _Initial(
      ...
      final bool error,
      final String message,
      final String? errorEmail}) = _$InitialImpl;
