...
abstract class _GetProducts implements HomeEvent {
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<ProductEntity> products, Failure? failure});
}
...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'HomeState(isLoading: $isLoading, products: $products, failure: $failure)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(_products), failure);
...
abstract class _Initial implements HomeState {
  const factory _Initial(
      ...
      final Failure? failure}) = _$InitialImpl;
